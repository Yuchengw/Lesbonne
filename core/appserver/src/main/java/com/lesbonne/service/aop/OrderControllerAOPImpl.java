...
public class OrderControllerAOPImpl {
	 ...
	 * */
	@Pointcut("execution(* com.lesbonne.bean.rest.controller.OrderController.*(..))")
	 ...
	 * */
	@AfterReturning(pointcut = "execution(* com.lesbonne.bean.rest.controller.OrderController.*(..))", returning = "result")
	 ...
	 * */
	@AfterThrowing(pointcut = "execution(* com.lesbonne.bean.rest.controller.OrderController.*(..))", throwing = "throwable")
