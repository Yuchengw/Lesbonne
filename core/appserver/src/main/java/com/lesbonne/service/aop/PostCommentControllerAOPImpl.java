package com.lesbonne.service.aop;
...
public class PostCommentControllerAOPImpl {
	 ...
	 * */
	@Pointcut("execution(* com.lesbonne.bean.rest.controller.PostCommentController.*(..))")
	 ...
	 * */
	@AfterReturning(pointcut = "execution(* com.lesbonne.bean.rest.controller.PostCommentController.*(..))", returning = "result")
	 ...
	 * */
	@AfterThrowing(pointcut = "execution(* com.lesbonne.bean.rest.controller.PostCommentController.*(..))", throwing = "throwable")
