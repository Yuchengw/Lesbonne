...
public class PostControllerAOPImpl {
	 ...
	 * */
	@Pointcut("execution(* com.lesbonne.bean.rest.controller.PostController.*(..))")
	 ...
	 * */
	@AfterReturning(pointcut = "execution(* com.lesbonne.bean.rest.controller.PostController.*(..))", returning = "result")
	 ...
	 * */
	@AfterThrowing(pointcut = "execution(* com.lesbonne.bean.rest.controller.PostController.*(..))", throwing = "throwable")
