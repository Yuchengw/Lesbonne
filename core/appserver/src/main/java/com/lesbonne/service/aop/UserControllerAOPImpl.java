...
public class UserControllerAOPImpl {
	 ...
	 * */
	@Pointcut("execution(* com.lesbonne.bean.rest.controller.UserController.*(..))")
	 ...
	 * */
	@AfterReturning(pointcut = "execution(* com.lesbonne.bean.rest.controller.UserController.*(..))", returning = "result")
	 ...
	 * */
	@AfterThrowing(pointcut = "execution(* com.lesbonne.bean.rest.controller.UserController.*(..))", throwing = "throwable")
