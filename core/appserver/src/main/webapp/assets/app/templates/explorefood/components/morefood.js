...
export default class MoreFood extends React.Component {
	render() {
		return (
			 <section className="value-pop">
		      <div className="container">
		        <div className="col-md-4">
		          <img className="img-responsive img-center" src="/as/scss/images/homemade-icon.png"/>
		          <h3>Home made food with love</h3>
		          <p>Extra portion of home made food coming from people share their passion</p>
		        </div>
		        <div className="col-md-4">
		          <img className="img-responsive img-center" src="/as/scss/images/instant-icon.png"/>
		          <h3>Instant Order</h3>
		          <p>Browse and order food instantly</p>
		        </div>
		        <div className="col-md-4">
		          <img className="img-responsive img-center" src="/as/scss/images/pickup-icon.png"/>
