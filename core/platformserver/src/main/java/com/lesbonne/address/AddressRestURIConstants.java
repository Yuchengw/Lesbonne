...
public class AddressRestURIConstants {
	...
	public static final String GET_ALL_CITIES = "/platform/v1/address/getAllCities";
	public static final String SEARCH_NEARBY_LOCATION = "/platform/v1/address/searchNearby/{latitude}/{longitude:.+}";
	public static final String SEARCH_CITY_ZIPCODE = "/platform/v1/address/searchCityOrZipcode/{cityOrZipcode}";
}
